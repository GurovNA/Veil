...
- Протоколы: выбор VLESS + Reality (маскировка под сайт, `www.samsung.com`), VMess + WebSocket или VLESS + WebSocket — домен не нужен, всё перенастраивается одной кнопкой
