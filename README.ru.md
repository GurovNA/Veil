...
- **Zapret2** (DPI-bypass) одним переключателем, веб-прокси на Nginx, **decoy-сайт** для обфускации: самодостаточная 8-битная NES-аркада (JSNES + две домашние игры, геймпад/тач/клавиатура, загрузка своего .nes локально в браузере, без CDN и исходящих запросов)
